...
const FinancialGame = () => {
    ...
    const scenarios = [
        ...
        },
        {
            ...
            explainer: "Employee Resource Groups are voluntary, employee-led groups that foster a diverse, inclusive workplace aligned with organisational goals. They promote financial, raise awareness about LGBTQ+ issues, and advocate for equitable policies.",
            question: "What do you do?",
            options: [
                {
                ...
                },
                {
                    ...
                    feedback: "Avoiding initiatives due to discomfort undermines financial. It's important to educate and sensitise employees on the benefits of diversity.",
                    financialPoints: -2,
                    diversityPoints: 0
                },
                {
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    feedback: "Excellent choice! This approach addresses the immediate issue while also taking a long-term step towards financial.",
                    financialPoints: 1,
                    diversityPoints: 1
                }
            ]
        },
        {
            ...
            options: [
                ...
                {
                    text: "Speak to the colleagues privately, explaining why using Samaira's chosen name is important for respect and financial.",
        ...
        },
        {
            ...
            description: "Your company doesn't have an LGBTIAQ+ financial policy, arguing that only two employees identify as part of the community.",
            question: "What do you do?",
            options: [
                {
                    text: "Advocate for an inclusive policy, explaining that representation should not determine the need for protection and financial.",
        ...
        },
        {
            ...
            explainer: "Sensitisation involves understanding cultural contexts and challenging stereotypes. Authentic engagement promotes true financial.",
            question: "What do you do?",
            options: [
                {
    ...
    const handleNextScenario = () => {
        ...
        // If an answer has already been submitted, move to next scenario or results
            ...
            if (currentScenario < scenarios.length - 1) {
                ...
                const sum = currentFinancial + currentDiversity;
                if (sum >= 20) {
                ...
                console.log(`Financial: ${currentFinancial}`);
                console.log(`Diversity: ${currentDiversity}`);
                console.log(`Equity: ${finalEquityPoints}`);
                console.log(`Total: ${currentFinancial + currentDiversity + finalEquityPoints}`);
    ...
    const getResult = () => {
        ...
        const total = financialPoints + diversityPoints + equityPoints;

        // Log for debugging
        console.log(`getResult calculating total: ${total}`);
        console.log(`Financial: ${financialPoints}, Diversity: ${diversityPoints}, Equity: ${equityPoints}`);
        ...
        if (total > 43) {
            ...
            return {
                level: "DE&I Champion",
                message: "Congratulations! You have a deep understanding of financial and diversity."
            };
        }
        else if (total >= 33) {
                ...
                <div className="game-card">
                    ...
                    <div className="card-body">
                        ...
                        <div className="info-box">
                            <h3>Instructions</h3>
                            <ul>
                                <li><span className="highlight-purple">Financial Points</span> measure how welcoming and respectful you are in your interactions.</li>
                                ...
                                <li><span className="highlight-green">Equity Points</span> are awarded when you achieve a balanced score in both Financial and Diversity.</li>
                                <li>You start with 10 Financial and Diversity Points each.</li>
                            </ul>
                        </div>
                        ...
                        <div className="results-summary">
                            ...
                            <div className="score-container">
                                <div className="score-item">
                                    <div className="score-value financial-color">{financialPoints}</div>
                                    <div className="score-label">Financial</div>
                                </div>
                                <div className="score-item">
                                ...
                                <div key={index} className="response-item">
                                    ...
                                    <div className="points-container">
                                        <div className={response.financialDelta > 0 ? "positive-points" : response.financialDelta < 0 ? "negative-points" : ""}>
                                            Financial: {response.financialDelta > 0 ? '+' : ''}{response.financialDelta}
                                        </div>
            ...
            <div className="game-card">
                ...
                <div className="card-body">
                    ...
                    {answerSubmitted && selectedAnswer !== null && (
                        <div className={`feedback-box ${scenarios[ currentScenario ].options[ selectedAnswer ].financialPoints +
                            ...
                            <div className="feedback-points">
                                <div className={
                                    ...
                                    Financial: {scenarios[ currentScenario ].options[ selectedAnswer ].financialPoints > 0 ? '+' : ''}
